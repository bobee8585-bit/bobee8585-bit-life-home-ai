...
const permissions = [
  ...
  ['PROPERTY.BROWSE_HISTORY', '최근 본 매물·검색 기록 관리'],
  ['PROPERTY.COMPARE', '매물 비교 관리'],
  ...
  ['PROPERTY.SAFETY_MANAGE', '전세 안전점수 근거 등록'],
...
async function seedModulesAndMenus(): Promise<void> {
  ...
  const menuSeeds = [
    ...
    {
      serviceModuleId: realEstate.id,
      code: 'SAVED_PROPERTY_SEARCH',
      name: '저장 검색·신규 매물 알림',
      platform: Platform.API,
      route: '/v1/saved-property-searches',
      apiScope: 'PROPERTY.SEARCH_SAVE',
      defaultState: MenuState.ACTIVE,
      sortOrder: 25,
    },
    {
    ...
    {
      serviceModuleId: realEstate.id,
      code: 'PROPERTY_BROWSING_HISTORY',
      name: '최근 본 매물·검색',
      platform: Platform.API,
      route: '/v1/property-browsing',
      apiScope: 'PROPERTY.BROWSE_HISTORY',
      defaultState: MenuState.ACTIVE,
      sortOrder: 26,
    },
    {
      serviceModuleId: realEstate.id,
      code: 'PROPERTY_COMPARISON',
      name: '매물 비교',
      platform: Platform.API,
      route: '/v1/property-comparisons',
      apiScope: 'PROPERTY.COMPARE',
      defaultState: MenuState.ACTIVE,
      sortOrder: 27,
    },
    {
      ...
      name: '방문 일정 캘린더',
      platform: Platform.API,
      route: '/v1/visit-calendar',
      apiScope: 'RESERVATION.RESPOND',
      defaultState: MenuState.ACTIVE,
      sortOrder: 31,
    },
    {
    ...
    {
      serviceModuleId: realEstate.id,
      code: 'ADMIN_PAYMENT_OPERATIONS',
      name: '관리자 결제·환불 운영',
      platform: Platform.ADMIN_CMS,
      route: '/admin/payments',
      apiScope: 'PAYMENT.READ',
      defaultState: MenuState.ACTIVE,
      sortOrder: 120,
    },
    {
