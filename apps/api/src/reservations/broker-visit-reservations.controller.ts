...
@MenuAccess('PROPERTY_RESERVATION_MANAGE', 'read')
@Controller('broker/visit-reservations')
export class BrokerVisitReservationsController {
  ...
  @MenuAccess('PROPERTY_RESERVATION_MANAGE', 'write')
